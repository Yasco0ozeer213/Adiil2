...
<div>
    <button id="cart-button">
        <a href="/events/details/<?php echo $eventid ?>">
...
<div>
    <div>
        <table>
            ...
            <tbody>
                <tr>
                    <td><?php echo strtoupper(htmlspecialchars($eventTitle)); ?></td>
                    <td>1</td>
        ...
        <?php if ($hasReduction): ?>
            <h3>Total après réductions &nbsp : &nbsp <?= number_format($priceWithReduction, 2, ',', ' ') ?> €</h3>
        <?php endif; ?>
    </div>
    ...
    <div>    
        ...
        <div id="carte_credit" class="mode_paiement_fields">
            <form method="POST" action="/events/subscribe">
                <input type="hidden" name="eventid" value="<?= $eventid ?>">
                <input type="hidden" name="price" value="<?= $priceWithReduction ?>">
                ...
                <button type="submit" id="finalise-button">Valider l'inscription</button>
            </form>
        </div>
